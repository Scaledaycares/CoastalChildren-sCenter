...
function startConversation() {
    fetch('https://chatbot-for-coastal-childrens-center-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-coastal-childrens-center-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbyzqtepvNTFaCGNnMMwhgcieQzLRgsoxyGcPy0svEaSZuUvlokiSq52CHkAv7LM-mj8/exec';
